...
public class Brademon implements Serializable {
	...
	public ArrayList<BrademonMove> moves;
	public transient BrademonMove moveInEdit;
	...
	public static Brademon generateNewBrademon(String name, String ownerName){
		...
		b.moves = new ArrayList<BrademonMove>();
	...
	public void addMove(String name){
		...
		moveInEdit = new BrademonMove(name);
		moveInEdit.pointsToSpend = level;
	}
	
	public void finalizeMove(){
	
		moves.add(moveInEdit);
		moveInEdit = null;
	}
	
	public BrademonMove getMove(String name){
